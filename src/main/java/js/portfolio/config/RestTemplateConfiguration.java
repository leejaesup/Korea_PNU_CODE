...
public class RestTemplateConfiguration {
    ...
    static class LoggingInterceptor implements ClientHttpRequestInterceptor {
        ...
        private void printRequest(final String sessionNumber, final HttpRequest req, final byte[] body) {
            log.info("session : {} - Request URI : {}, Method : {} Headers : {}, Body : {}", sessionNumber, req.getURI(), req.getMethod(), req.getHeaders(), new String(body, StandardCharsets.UTF_8));
        }
        ...
        private void printResponse(final String sessionNumber, final ClientHttpResponse res) throws IOException {
            ...
            log.info("session : {} - Status : {}, Headers : {}, Body : {}", sessionNumber, res.getStatusCode(), res.getHeaders(), body);
        }
    }
}
